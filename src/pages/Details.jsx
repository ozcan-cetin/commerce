    ...
    <div>
      ...
      <div className="container row m-auto">
        <div className="col-12">
          <button
            className="details-backBtn text-uppercase p-2 border-0 rounded-2 my-1"
          ...
          <div className="d-flex justify-content-between mt-1">
            {newImages?.map((item, index) => {
              return (
                <div
                  key={index}
                  className="card details-imgDiv-bottom"
        ...
        <div className="details-content col-md-6">
          ...
          <div className="stars fs-4 d-flex align-items-center flex-row text-warning">
            ...
            <span className="single-detail-review d-flex align-items-center fs-5 ps-2">
              ...
              {colors?.map((item, tickIndex) => {
                return (
                  <button
                    ...
                    onClick={() => setTickColor(tickIndex)}
                  >
                    {tickColor === tickIndex ? (
                      <TiTick className="text-white m-1 fs-5" />
                    ) : (
                      <p className="default-color mx-2">
                        <TiTick />
                      </p>
                    )}
                  </button>
          ...
          <button
            onClick={addToCart}
            className="cartBtn p-2 border-0 rounded-2 my-1"
          >
            ADD TO CART
          </button>
        </div>
