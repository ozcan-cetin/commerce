...
const Header = () => {
  ...
  return (
    <header className="d-flex align-items-center row container m-auto mt-lg-2 mt-xl-3">
      <div className="header-desc col-lg-6">
        ...
        <button className="border-0 fs-4 py-1 px-3 rounded-1 text-white" onClick={() => navigate("/products")}>SHOP NOW</button>
      </div>
